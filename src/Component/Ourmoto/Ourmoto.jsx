    ...
    <section className="bg-gradient-to-br from-white via-purple-50 to-white py-20 px-6 md:px-12 text-center">
      <div className="max-w-5xl mx-auto">
        <motion.h2
          ...
          className="text-5xl font-extrabold bg-gradient-to-r from-purple-700 via-pink-500 to-red-500 text-transparent bg-clip-text mb-6"
        >
          {title}
        </motion.h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 text-gray-700">
          ...
          >
            ...
            <h4 className="text-xl font-semibold mb-2">Community Empowerment</h4>
            <p className="text-sm">
          ...
          >
            ...
            <h4 className="text-xl font-semibold mb-2">Innovation Growth</h4>
            <p className="text-sm">
